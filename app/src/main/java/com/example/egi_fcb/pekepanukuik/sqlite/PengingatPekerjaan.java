...
public class PengingatPekerjaan {
    ...
    public String getTxt_jam_akhir(){
        return txt_jam_akhir;
    }

    public void setTxt_jam_akhir(String txt_jam_akhir){
        this.txt_jam_akhir = txt_jam_akhir;
    }
