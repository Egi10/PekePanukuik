package com.example.egi_fcb.pekepanukuik.ZUsangDaftarListView;
...
public class Daftar_Costum_ListView extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.tambah:
                Intent intent2 = new Intent(getApplicationContext(), Simpan_Activity.class);
                startActivity(intent2);
                Daftar_Costum_ListView.this.finish();
                return true;
