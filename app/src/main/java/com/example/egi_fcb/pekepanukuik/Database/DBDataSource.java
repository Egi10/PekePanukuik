...
public class DBDataSource {
    ...
    private String[] allcolumns = {DBHelper.COLUMN_id, DBHelper.COLUMN_hari, DBHelper.COLUMN_tanggal,
                                   DBHelper.COLUMN_jam, DBHelper.COLUMN_pekerjaan};
    ...
    public PengingatPekerjaan createpake(String hari, String tanggal, String jam, String Pekerjaan){
    ...
    private PengingatPekerjaan cursorTopake(Cursor cursor){
        ...
        pengingatPekerjaan.setTxt_pekerjaan(cursor.getString(4));
    ...
    //Table Sampah
    //Menthod Untuk Create/insert
    public PengingatPekerjaan createsampah(String hari, String tanggal, String jam, String Pekerjaan){
        ContentValues values = new ContentValues();
        values.put(DBHelper.COLUMN_hari, hari);
        values.put(DBHelper.COLUMN_tanggal, tanggal);
        values.put(DBHelper.COLUMN_jam, jam);
