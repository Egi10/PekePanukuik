        ...
        if(row == null){
            ...
            switch (posisi){
                case 0 :
                    ...
                    imageView.setImageResource(R.mipmap.image_input);
                break;

                case 1 :
                    textView.setText("DAFTAR");
                    imageView.setImageResource(R.mipmap.image_list);
                    break;

                case 2 :
                    textView.setText("SAMPAH");
                    imageView.setImageResource(R.mipmap.image_sampah);
                break;

                case 3 :
                    textView.setText("KELUAR");
                    imageView.setImageResource(R.mipmap.image_keluar);
                break;
            }
        }
        return row;
